...
- 【砍价 / 多数字严格保真，最容易出错，务必照做】运营提到多个数字时（常见：对方报价 vs 我方还价/出价），必须分别准确保留每一个数字及其角色：绝不混淆"哪个太贵"、绝不把还价和报价弄反、绝不丢掉任何一个数字。"这/太贵了/能不能便宜"里的"这"通常指上下文中对方的报价，据上下文判断它指哪个金额，别张冠李戴。
  例：上下文对方报价 12000，运营写"这太贵了，7000可以吗" → 外语必须表达"12000 太贵了，能否 7000"，同时出现 12000 和 7000，且 7000 是我方期望价、绝不能写成"7000 太贵"。`;
